...
/// or fake responses.
abstract class MongolTestWidgetsFlutterBinding extends BindingBase
  ...
  MongolTestWidgetsFlutterBinding() : _window = TestWindow(window: ui.window) {
  ...
  ///
  /// In the live test environemnt ([MongolLiveTestWidgetsFlutterBinding], typically
  ...
  /// [MongolLiveTestWidgetsFlutterBinding] otherwise (e.g. if it was run
  ...
  /// [MongolLiveTestWidgetsFlutterBinding], so this function will always set up an
  ...
  MongolEditableTextState? get focusedEditable => _focusedEditable;
  MongolEditableTextState? _focusedEditable;
  set focusedEditable(MongolEditableTextState? value) {
  ...
  ///
  /// The `description` is used by the [MongolLiveTestWidgetsFlutterBinding] to
...
/// run in checked mode).
class MongolAutomatedTestWidgetsFlutterBinding extends MongolTestWidgetsFlutterBinding {
  @override
  void initInstances() {
    super.initInstances();
  ...
  @override
  Timeout defaultTestTimeout = const Timeout(Duration(minutes: 10));
...
/// anyway.)
class MongolLiveTestWidgetsFlutterBinding extends MongolTestWidgetsFlutterBinding {
  @override
